...
<legend><b>Choisissez vos statistiques</b></legend> 
		<a href="${pageContext.request.contextPath}/spring/statCategCroissant">			
			Catégories par ordre croissant 
		</a>
		<br/>
		<a href="${pageContext.request.contextPath}/spring/statCategDecroissant">		
